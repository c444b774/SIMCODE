...
public:
	...
	***************************************************************** */
	BOOL CreateNode(LPCTSTR path, XMLNode & nodeCreated,LPCTSTR nodeText=NULL);

	BOOL CreateChildNode(XMLNode nodeParent,LPCTSTR path, XMLNode & nodeCreated,LPCTSTR nodeText=NULL);
