#include "stdafx.h"
#include "EndWCDMACal.h"
RF_IMPLEMENT_DYNCREATE(CEndWCDMACal)

CEndWCDMACal::CEndWCDMACal()
{
	m_mapClassFunc[_T("EndWCDMACalMainFunc")]=&CEndWCDMACal::CEndWCDMACalMainFunc;
	m_mapClassFunc[_T("EndWCDMACalFunc")]=&CEndWCDMACal::CEndWCDMACalFunc;
}
...
bool CEndWCDMACal::DoProcess()
{
	 return CALL_MEMBER_FN(*this, m_fpMainFunc)();
}

bool  CEndWCDMACal::Handle()
{
	if(!DoProcess())
	{
	...
	CalPassLog("_","_","End WCDMA Cal Pass");

	return true;
}

bool CEndWCDMACal::CEndWCDMACalMainFunc()
{
...
bool CEndWCDMACal::CEndWCDMACalFunc()
{
