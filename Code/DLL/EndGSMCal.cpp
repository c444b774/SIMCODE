#include "stdafx.h"
#include "EndGSMCal.h"
RF_IMPLEMENT_DYNCREATE(CEndGSMCal)

CEndGSMCal::CEndGSMCal()
{
	m_mapClassFunc[_T("EndGSMCalMainFunc")]=&CEndGSMCal::CEndGSMCalMainFunc;
	m_mapClassFunc[_T("EndGSMCal")]=&CEndGSMCal::CEndGSMCalFunc;
	m_mapClassFunc[_T("EndGSMCal6285")]=&CEndGSMCal::CEndGSMCalFunc6285;
}
...
bool CEndGSMCal::DoProcess()
{
	 return CALL_MEMBER_FN(*this, m_fpMainFunc)();
}

bool  CEndGSMCal::Handle()
{
	if(!DoProcess())
	{
	...
	CalPassLog("_","_","End GSM Cal Pass");

	return true;
}

bool CEndGSMCal::CEndGSMCalMainFunc()
{
...
bool CEndGSMCal::CEndGSMCalFunc6285()
{
	CString strMsg;
    int iErrorcode;
...
bool CEndGSMCal::CEndGSMCalFunc()
{
