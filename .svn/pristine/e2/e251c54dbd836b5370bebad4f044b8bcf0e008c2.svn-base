#include "StdAfx.h"
#include "EndTDSCal.h"
RF_IMPLEMENT_DYNCREATE(CEndTDSCal)

CEndTDSCal::CEndTDSCal(void)
{
	m_mapClassFunc[_T("EndTDSCalMainFunc")]=&CEndTDSCal::CEndTDSCalMainFunc;
	m_mapClassFunc[_T("EndTDSCalFunc")]=&CEndTDSCal::CEndTDSCalFunc;
}

CEndTDSCal::~CEndTDSCal(void)
{
}
bool CEndTDSCal::DoProcess()
{
	 return CALL_MEMBER_FN(*this, m_fpMainFunc)();
}

bool  CEndTDSCal::Handle()
{
	if(!DoProcess())
	{
	...
	CalPassLog("_","_","End TDSCDMA Cal Pass");

	return true;
}

bool CEndTDSCal::CEndTDSCalMainFunc()
{
...
bool CEndTDSCal::CEndTDSCalFunc()
{
