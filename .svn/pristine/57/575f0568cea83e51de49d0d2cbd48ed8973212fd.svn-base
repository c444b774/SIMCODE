 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_NVTool.h#4 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   QLIB_API void QLIB_NV_LoadNameFromNVDefinitionFile( HANDLE hResourceContext, bool bLoadNameFromNVDefinitionFile);
